...
const Navbar = () => {
  ...
  return (
    <div>
      <div className={` ${user.role !== 'student' && user.role !== undefined ? 'flex' : 'hidden'} `}>
     <QuizzAdd/>
      </div>
      ...
      <div className="flex justify-between items-center p-3 border border-gray-300 bg-gray-100">
        ...
        >
          ...
          <div
            className={`absolute text-black top-[35px] right-[-14px] shadow-md bottom-0 overflow-hidden bg-white h-[200px]  ${
