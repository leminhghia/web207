...
const PagesHome = () => {
  return (
    <div className="flex-col w-full">
      {/* 1 */}
      <div className="flex items-center justify-center bg-gradient-to-r from-purple-50 to-white min-h-screen py-12 px-4 lg:px-8">
        <div className="text-center max-w-3xl mt-10	">
          ...
          {/* Main Heading */}
          <h1 className="text-4xl font-bold text-gray-800 mb-2 flex flex-col leading-relaxed text-start ml-16">
            Có một cách đơn giản hơn để{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4864fc] to-[#d03cfc] h-auto min-h-[40px] pb-1 text-5xl mb-3 mt-3 p-1">
              <ReactTyped
                strings={[
                  'tự động tạo câu hỏi',
                  'tạo nhanh đề thi',
          ...
          <hr className="w-[125px] ml-16 mb-4 h-[2px] bg-gradient-to-r from-[#4864fc] to-[#d03cfc] border-0 rounded-full" />

          {/* Subtitle */}
          <p className="text-lg text-gray-600 mb-6 text-start ml-16 w-[500px]">
          ...
          {/* Action Buttons */}
          <div className="flex gap-4 mb-12 ml-16 mt-3">
        ...
        {/* Banner */}
        <div className="">
          <img src={assets.BANNERHOME} alt="" width="700" height="700" />
        </div>
      </div>
      {/*  */}
            ...
            <div className="flex-col space-y-5 w-full">
              <div className="flex justify-between w-full gap-2">
                <div className="text-center w-1/5 ">
                  <p className="text-left font-medium text-lg flex items-center gap-2">
                    <HiOutlineUserCircle style={{ color: '#8F82FC' }} />
                    Sinh viên
                  </p>{' '}
                  {/* Đảm bảo chữ căn lề trái */}
                  <p className="text-left mt-3">
                    Nền tảng trao đổi đề thi, tài liệu học tập. Thông qua việc
                    tự tạo đề, sinh viên có thể tự học với bộ tài liệu phù hợp
                    đồng thời chia sẻ cho nhóm học tập.
                  </p>
                ...
                <div className="w-1/5 text-center">
                  ...
                  {/* Đảm bảo chữ căn lề trái */}
                  <p className="text-left mt-3">
                    Thao tác tạo đề đơn giản, chính xác cùng phương pháp đánh
                    giá hiệu quả, giúp giảng viên dễ dàng quản lý bài giảng và
                ...
                <div className="w-1/5 text-center ">
                  ...
                  {/* Đảm bảo chữ căn lề trái */}
                  <p className="text-left mt-3">
                    Nền tảng hỗ trợ chi tiết về kỹ thuật giúp các doanh nghiệp
                    nhanh chóng tổ chức và sắp xếp các nội dung đào tạo cho cán
                    bộ công nhân viên.
                  </p>
      ...
      <div className="w-full  mt-8 bg-[#F6F8FF] p-7">
        <div className="flex-col space-y-5 w-full justify-center">
          <p className="flex justify-center text-3xl text-transparent bg-clip-text bg-gradient-to-r from-[#4864fc] to-[#d03cfc] pb-1">
          ...
          <div className="flex justify-center mt-3">
            <div className="w-1/2   flex justify-center">
              <div>
                ...
                <p className="mt-6 flex items-start gap-2 w-80 ">
                  <MdOutlineAirplay style={{ color: '#8F82FC' }} size={50} />
                  Tạo đề nhanh với vài cú nhấp chuột. Bằng cách nhập file tài
                  liệu định dạng WORD hoặc PDF, AI sẽ giúp bạn tạo đề chính xác
                  100% trong vài phút.
                </p>
                <p className="mt-6 flex items-start gap-2 w-80">
                  <MdOutlineAirplay style={{ color: '#8F82FC' }} size={50} />
                  Tối ưu trải nghiệm, tiết kiệm thời gian, công sức, đảm bảo
                  tính khách quan và có thêm thời gian nghiên cứu, học tập.
                </p>
            ...
            <div className="w-1/2">
              <div className="mr-5">
                <img src={assets.AIBANNER} alt="" size={100} />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full  mt-8 bg-[#F6F8FF] p-7">
        <div className="flex-col space-y-5 w-full justify-center">
          <div className="flex justify-center mt-3">
            <div className="w-1/2">
              <div className="mr-5">
                <img src={assets.TOIUU} alt="" size={100} />
              </div>
            </div>
            <div className="w-1/2   flex justify-center">
              <div>
      ...
      <div className="w-full  mt-8 bg-[#F6F8FF] p-7">
        <div className="flex-col space-y-5 w-full justify-center">
          <div className="flex justify-center mt-3">
            <div className="w-1/2">
              <div className="mr-5">
                <img src={assets.HIEUQUA} alt="" size={100} />
              </div>
            </div>
            <div className="w-1/2   flex justify-center">
              <div>
      ...
      {/*  */}
      <div className="flex justify-center mt-8 br">
        <FeedbackSection />
      </div>
    </div>
  )
