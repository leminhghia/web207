...
const PagesHome = () => {
  return (
    <div className="flex-col w-full">
      {/* 1 */}
      <div className="flex flex-col lg:flex-row items-center justify-center bg-gradient-to-r from-purple-50 to-white min-h-screen py-12 px-4 lg:px-8">
        {/* Nội dung chính */}
        <div className="text-center max-w-3xl mt-10 lg:mr-8">
          {/* Header Tagline */}
        ...
        <div className="mt-8 lg:mt-0">
          <img src={assets.BANNERHOME} alt="Banner" width="700" height="700" />
        </div>
      </div>
      {/*  */}
